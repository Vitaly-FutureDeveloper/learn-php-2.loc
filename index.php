...
//Пишем логи посещений пользователя по сайту
include 'inc/log.inc.php'; // Скрипт снифера
		...
		<div id="content">
			...
			<blockquote>
				...
				if($visitCounter == 1) {
					...
					echo "<p>Вы зашли к нам: $visitCounter раз<br>";
					echo "Последнее посещение: $lastVisit</p>";
				}
				?>
			</blockquote>
			<!-- Заголовок -->
